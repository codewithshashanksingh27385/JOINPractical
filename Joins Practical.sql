create database JoinImplementation;
...
create table Customers(CustomerId int primary key, Customer_Name varchar(50), City varchar(50) not null, orderId int not null, FOREIGN KEY (orderId) REFERENCES Orders(orderID));
/*insert orders values in order table*/
